...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("mrkchrstn0");
        ...
        pattern = Pattern.compile("markchristian87@gmail.com");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("https://www.marktupas.com(e.g. http://");
        ...
        // Provide regex pattern
        pattern = Pattern
                .compile("report.pptx, registration2020.txt, hacker.cpp, project2019.xlsx");
        ...
        tweet = tweet.replaceAll("I'd pet a million stray pit bulls before I'd eat a single pink-slimy McBite. ","McDStories http://bit.ly/wd0BDe");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("The oldest living survivor of the Japanese Attack on Pearl Harbor in 1941 celebrated his upcoming 105th birthday at the National World War II Museum in New Orleans. ", "Joseph Eskenazi of Redondo Beach, California, boarded a train Friday for the journey. ");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("Press On, three, was killed training this morning at Santa Anita musculoskeletal, for now.", "He is the sixth dead horse at Cal tracks through the first three weeks of 2023. “Reform” is a ruse, “safe racing” a lie. Horseracing kills; it must end. ");
    ...
    public static Object Replace(String str, String string, String string2) {
        return null;
    }
}
